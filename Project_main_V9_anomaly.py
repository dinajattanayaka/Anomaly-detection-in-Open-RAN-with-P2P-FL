...
if __name__ == '__main__':
    ...
    no_of_training_samples = 100000  # Number of samples used 
#     anomaly_percentage = 0.6
    anomaly_percentage_ls = np.arange(0.15, 0.901, 0.005)
...
#     cluster_anomaly_list = [0.6, 0.5, 0.4, 0.5, 0.6]
    ...
    NUM_ROUNDS = 50
#     NUM_ROUNDS_ls=list(range(10, 81,1))
#     NUM_ROUNDS_ls = [5]
    ...
    random_TargetEnc_file_path = "random/random_TargetEnc_12112022_anomaly.pkl"
    random_Clustered_file_path = "random/random_Clustered_12112022_anomaly.pkl"
    random_Hierarchical_file_path = "random/random_Hierarchical_12112022_anomaly.pkl"
    random_General_file_path = "random/random_General_12112022_anomaly.pkl"
    random_Centralized_file_path = "random/random_Centralized_12112022_anomaly.pkl"
    random_Homomorphic_file_path = "random/random_Homomorphic_12112022_anomaly.pkl"

    IID_TargetEnc_file_path = "IID/IID_TargetEnc_12112022_anomaly.pkl"
    IID_Clustered_file_path = "IID/IID_Clustered_12112022_anomaly.pkl"
    IID_Hierarchical_file_path = "IID/IID_Hierarchical_12112022_anomaly.pkl"
    IID_General_file_path = "IID/IID_General_12112022_anomaly.pkl"
    IID_Centralized_file_path = "IID/IID_Centralized_12112022_anomaly.pkl"
    IID_Homomorphic_file_path = "IID/IID_Homomorphic_12112022_anomaly.pkl"


    non_IID_TargetEnc_file_path = "non_IID/non_IID_TargetEnc_12112022_anomaly.pkl"
    non_IID_Clustered_file_path = "non_IID/non_IID_Clustered_12112022_anomaly.pkl"
    non_IID_Hierarchical_file_path = "non_IID/non_IID_Hierarchical_12112022_anomaly.pkl"
    non_IID_General_file_path = "non_IID/non_IID_General_12112022_anomaly.pkl"
    non_IID_Centralized_file_path = "non_IID/non_IID_Centralized_12112022_anomaly.pkl"
    non_IID_Homomorphic_file_path = "non_IID/non_IID_Homomorphic_12112022_anomaly.pkl"
...
#     print(f'Random anomaly percentages : {random_anomaly_dic}')
    ...
    for anomaly_percentage in anomaly_percentage_ls:

        print(f'Starting the cycle of Anomaly Percentage: {anomaly_percentage}') 
