...
if __name__ == '__main__':
    ...
    print('\n')
    print("File names ends with: 03112022")
    print('\n')
    ...
    no_of_training_samples = 150000  # Number of samples used 
...
#     cluster_anomaly_list = [0.6, 0.5, 0.4, 0.5, 0.6]
    ...
    BATCH_SIZE = 100
    # BATCH_SIZE_ls = [100]
    # BATCH_SIZE_ls = list(range(20, 1020, 20))
...
#     NUM_ROUNDS_ls = [5]
    ...
    random_TargetEnc_file_path = "random/random_TargetEnc_07112022_rounds.pkl"
    random_Clustered_file_path = "random/random_Clustered_07112022_rounds.pkl"
    random_Hierarchical_file_path = "random/random_Hierarchical_07112022_rounds.pkl"
    random_General_file_path = "random/random_General_07112022_rounds.pkl"
    random_Centralized_file_path = "random/random_Centralized_07112022_rounds.pkl"
    random_Homomorphic_file_path = "random/random_Homomorphic_07112022_rounds.pkl"

    IID_TargetEnc_file_path = "IID/IID_TargetEnc_07112022_rounds.pkl"
    IID_Clustered_file_path = "IID/IID_Clustered_07112022_rounds.pkl"
    IID_Hierarchical_file_path = "IID/IID_Hierarchical_07112022_rounds.pkl"
    IID_General_file_path = "IID/IID_General_07112022_rounds.pkl"
    IID_Centralized_file_path = "IID/IID_Centralized_07112022_rounds.pkl"
    IID_Homomorphic_file_path = "IID/IID_Homomorphic_07112022_rounds.pkl"


    non_IID_TargetEnc_file_path = "non_IID/non_IID_TargetEnc_07112022_rounds.pkl"
    non_IID_Clustered_file_path = "non_IID/non_IID_Clustered_07112022_rounds.pkl"
    non_IID_Hierarchical_file_path = "non_IID/non_IID_Hierarchical_07112022_rounds.pkl"
    non_IID_General_file_path = "non_IID/non_IID_General_07112022_rounds.pkl"
    non_IID_Centralized_file_path = "non_IID/non_IID_Centralized_07112022_rounds.pkl"
    non_IID_Homomorphic_file_path = "non_IID/non_IID_Homomorphic_07112022_rounds.pkl"
    ...
    ####################################################################################### Federated Learning #######################################################################################
    for NUM_ROUNDS in NUM_ROUNDS_ls:
        print('\n')
        print(f'Starting the cycle of total rounds: {NUM_ROUNDS}')
    ...
    #     print(f'Starting the cycle of batch size: {BATCH_SIZE}') 
        ...
        print('\n')
        print(f'>>>>>>>> Starting IID TaregtEncod <<<<<<<<')
        print('\n')
...
#         print('\n')
#         print(f'>>>>>>>> Starting random Homomorphic <<<<<<<<')
#         print('\n')
#         Homomorphic_model(NUM_CLIENTS, no_of_training_samples, number_of_test_data, anomaly_percentage, cluster_anomaly_percentage, random_anomaly_dic, BATCH_SIZE, NUM_EPOCHS, NUM_ROUNDS, X_test, y_test, client_train_dataset_IID, IID_Homomorphic_file_path)
...
#         print(f'>>>>>>>> Starting random Homomorphic <<<<<<<<')
#         print('\n')
#         Homomorphic_model(NUM_CLIENTS, no_of_training_samples, number_of_test_data, anomaly_percentage, cluster_anomaly_percentage, random_anomaly_dic, BATCH_SIZE, NUM_EPOCHS, NUM_ROUNDS, X_test, y_test, client_train_dataset_non_IID, non_IID_Homomorphic_file_path)
